...
const (
	...
	HealthService_Ready_FullMethodName = "/api.v1.HealthService/Ready"
)
...
type HealthServiceClient interface {
	...
	Ready(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error)
}
...
func (c *healthServiceClient) Ready(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthResponse)
...
type HealthServiceServer interface {
	...
	Ready(context.Context, *emptypb.Empty) (*HealthResponse, error)
...
func (UnimplementedHealthServiceServer) Ready(context.Context, *emptypb.Empty) (*HealthResponse, error) {
